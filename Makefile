...
start:
	@docker run --name coredns -p 1153:53/udp -p 1153:53/tcp -p 1443:1443 -p 1953:1953 -d hub.fxn.tech/coredns:$(APP_VERSION) -conf /coredns/deployment/$(APP_PROFILE)/Corefile
